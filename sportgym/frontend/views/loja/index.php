...
<div class="produto-index">
    <div class="row">
        ...
        <div class="col-xs-6">
            <?= Html::a('<span style="float:right;margin-top:15px;font-size:24px;"><img src="/imgs/compras_carro.png" width="30" height="30" style="margin-right: 8px;">('.number_format($venda->total, 2).'€)</span>', ['carrinho']) ?>
        </div>
    </div>
    <hr class="hr">
    <br>

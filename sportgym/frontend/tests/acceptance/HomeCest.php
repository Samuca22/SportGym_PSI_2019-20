...
/*
    ...
    public function testMinhasAulas(AcceptanceTester $I)
    {
        $I->amOnPage('/site/index');
        
        //$I->click(['link' => 'Minha Conta']);
        
        $I->selectOption('Minha Conta','Minhas Aulas');
/*
        $I->click(['link' => 'Minha Conta']);
        $I->wait(3);
        $I->click(['link' => 'Minhas Aulas']);

        $I->wait(1);
        $I->amOnPage('/perfil-aula/index');
        */
        $I->see('Minhas Aulas', 'h3');
    }
}
